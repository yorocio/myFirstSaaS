    ...
    <form className="font-[sans-serif] text-[#333] max-w-4xl mx-auto px-6 mt-28 mb-20">
      <div className="grid sm:grid-cols-2 gap-10">
        <div className="relative flex items-center">
          <label className="text-lg absolute top-[-10px] left-0">First Name</label>
          <input type="text" placeholder="Enter first name" className="px-2 pt-5 pb-2 bg-white w-full text-sm border-b-2 border-gray-100 focus:border-[#333] outline-none" />
        ...
        <div className="relative flex items-center">
          <label className="text-lg absolute top-[-10px] left-0">Last Name</label>
          <input type="text" placeholder="Enter last name" className="px-2 pt-5 pb-2 bg-white w-full text-sm border-b-2 border-gray-100 focus:border-[#333] outline-none" />
          <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-[18px] h-[18px] absolute right-2"
            viewBox="0 0 24 24">
            <circle cx="10" cy="7" r="6" dataoriginal="#000000"></circle>
            <path d="M14 15H6a5 5 0 0 0-5 5 3 3 0 0 0 3 3h12a3 3 0 0 0 3-3 5 5 0 0 0-5-5zm8-4h-2.59l.3-.29a1 1 0 0 0-1.42-1.42l-2 2a1 1 0 0 0 0 1.42l2 2a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42l-.3-.29H22a1 1 0 0 0 0-2z" dataoriginal="#000000"></path>
        ...
        <div className="relative flex items-center">
          <label className="text-lg absolute top-[-10px] left-0">Phone No</label>
          <input type="number" placeholder="Enter phone no." className="px-2 pt-5 pb-2 bg-white w-full text-sm border-b-2 border-gray-100 focus:border-[#333] outline-none" />
        ...
        <div className="relative flex items-center">
          <label className="text-lg absolute top-[-10px] left-0">Country</label>
          <input type="text" placeholder="Enter country" className="px-2 pt-5 pb-2 bg-white w-full text-sm border-b-2 border-gray-100 focus:border-[#333] outline-none" />
        ...
        <div className="relative flex items-center sm:col-span-2">
          ...
          <input type="email" placeholder="Enter email" className="px-2 pt-5 pb-2 bg-white w-full text-sm border-b-2 border-gray-100 focus:border-[#333] outline-none" />
        ...
        <div className="relative flex items-center sm:col-span-2">
          <label className="text-lg absolute top-[-10px] left-0">Password</label>
          <input type="password" autoComplete="new-password" placeholder="Enter password" className="px-2 pt-5 pb-2 bg-white w-full text-sm border-b-2 border-gray-100 focus:border-[#333] outline-none" />
      ...
      <button type="button" className="mt-10 mb-20 px-2 py-2.5 w-full rounded-sm text-base bg-[#333] hover:bg-[#222] text-white">Register</button>
    </form>
  )
}
