...
const Login = () => {
    return (
        <div className="space-y-6 font-[sans-serif] max-w-md mx-auto mt-28">
            ...
            <button type="submit" className="mt-10 px-2 py-2.5 w-full rounded-sm text-sm bg-[#333] hover:bg-[#222] text-white">Submit</button>
        </div>
    )
}
