  ...
  return (
    <header className='flex shadow-md py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50'>
      <div className='flex flex-wrap items-center justify-between gap-5 w-full'>
        <Link href="#" className="max-sm:hidden"><Image src="https://readymadeui.com/readymadeui.svg" alt="logo" width={36} height={36} /></Link>
        <Link href="#" className="hidden max-sm:block"><Image src="https://readymadeui.com/readymadeui-short.svg" alt="logo" width={36} height={36} /></Link>
        ...
        <div id="collapseMenu"
          ...
          <ul
            ...
            <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
              <Link href="/"
                className='hover:text-gray-400 text-gray-800 block font-semibold text-[15px]'>Home</Link>
            </li>
            <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><Link href="#"
              className='hover:text-gray-400 text-gray-800 block font-semibold text-[15px]'>Team</Link>
            </li>
            <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><Link href="#"
              className='hover:text-gray-400 text-gray-800 block font-semibold text-[15px]'>Feature</Link>
            </li>
            <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><Link href="#"
              className='hover:text-gray-400 text-gray-800 block font-semibold text-[15px]'>Blog</Link>
            </li>
            <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><Link href="#"
              className='hover:text-gray-400 text-gray-800 block font-semibold text-[15px]'>About</Link>
            </li>
            <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><Link href="#"
              className='hover:text-gray-400 text-gray-800 block font-semibold text-[15px]'>Contact</Link>
            </li>
          </ul>
        </div>
