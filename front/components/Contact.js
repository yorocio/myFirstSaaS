        ...
        <section className='mt-28 mb-10'>
            <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-6 font-[sans-serif]">
                ...
                <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
                    ...
                    <div className="bg-gray-800 rounded-lg p-6 h-full max-lg:order-1">
                        <h2 className="text-xl text-white">Información de contacto</h2>
                        <p className="text-sm text-gray-300 mt-4">No dudes en comunicarte con nosotros a través de estos medios si necesitas información o tienes alguna consulta sobre nuestros servicios. Estaremos encantados de atenderte. ¡Gracias!</p>
                            ...
                            <div className="grid sm:grid-cols-2 gap-8">
                                <div className="relative flex items-center">
                                    <input type="text" placeholder="Nombre"
                                        className="px-2 py-3 bg-white w-full text-sm text-gray-800 border-b border-gray-300 focus:border-gray-900 outline-none" />
                                ...
                                <div className="relative flex items-center">
                                    <input type="number" placeholder="Número del Teléfono"
                                        className="px-2 py-3 bg-white w-full text-sm text-gray-800 border-b border-gray-300 focus:border-gray-900 outline-none" />
                                ...
                                <div className="relative flex items-center sm:col-span-2">
                                    <textarea placeholder="Escribe tu mensaje"
                                        className="px-2 pt-3 bg-white w-full text-sm text-gray-800 border-b border-gray-300 focus:border-gray-900 outline-none"></textarea>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-[18px] h-[18px] absolute right-2"
                                        viewBox="0 0 682.667 682.667">
                                        <defs>
                                            <clipPath id="a" clipPathUnits="userSpaceOnUse">
                                ...
                                <div className="col-span-full">
                                    <h6 className="text-sm text-gray-800">Selecciona un asunto</h6>
                                    <div className="flex max-lg:flex-col gap-6 mt-4">
                                        <div className="flex items-center">
                                            <input id="radio1" type="radio" name="value1" className="hidden peer" />
                                            <label
                                                className="relative p-0.5 flex items-center justify-center border-2 border-gray-800 rounded-full overflow-hidden">
                                                <span className="border-[4px] border-gray-800 rounded-full w-full h-full"></span>
                                            </label>
                                            <p className="text-sm text-gray-800 ml-4">Consulta General</p>
                                        </div>
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <p className="text-sm text-gray-800 ml-4">Soporte Técnico</p>
                                        </div>
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <p className="text-sm text-gray-800 ml-4">Comentarios sobre el sitio web</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
