        ...
        <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-6 font-[sans-serif]">
            ...
            <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
                ...
                <div className="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
                    ...
                    <p className="text-sm text-gray-300 mt-4">Feel free to reach out to us through these channels if you need assistance, have any questions, or would love to be a part of our team. We’ll be happy to get in touch with you. Thank you so much!</p>
                            ...
                            <div className="col-span-full">
                                ...
                                <div className="flex max-lg:flex-col gap-6 mt-4">
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-sm text-gray-800 ml-4">General Inquiry</p>
                                    </div>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-sm text-gray-800 ml-4">Technical Support</p>
                                    </div>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-sm text-gray-800 ml-4">Website Feedback</p>
                                    </div>
                                </div>
                            </div>
                        </div>
